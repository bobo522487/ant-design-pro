...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  ...
  const basicFormRef = useRef<ProFormInstance<FormValueType>>(undefined);
  const propertyFormRef = useRef<ProFormInstance<FormValueType>>(undefined);
  const scheduleFormRef = useRef<ProFormInstance<FormValueType>>(undefined);

  const resetForms = useCallback(() => {
    basicFormRef.current?.resetFields();
    propertyFormRef.current?.resetFields();
